...
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
	...
	('def', 'tienda', 'articulos', 'cod', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
	('def', 'tienda', 'articulos', 'nombre', 2, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'tienda', 'articulos', 'precio', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
	('def', 'tienda', 'articulos', 'id', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
	('def', 'tienda', 'categorias', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
	('def', 'tienda', 'categorias', 'nombre', 2, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'wifi', 'admins', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	('def', 'wifi', 'admins', 'usuario', 2, '0', 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'wifi', 'admins', 'password', 3, '0', 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'wifi', 'categorias', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	('def', 'wifi', 'categorias', 'nombre', 2, '0', 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'wifi', 'productos', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	('def', 'wifi', 'productos', 'nombre', 2, '0', 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'wifi', 'productos', 'precio', 3, '0', 'NO', 'decimal', NULL, NULL, 10, 0, NULL, NULL, 'decimal(10,0)', '', '', 'select,insert,update,references', ''),
	('def', 'wifi', 'productos', 'descripcion', 4, '0', 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'wifi', 'productos', 'idCategoria', 5, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
	('def', 'wifi', 'usuarios', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	('def', 'wifi', 'usuarios', 'nombre', 2, '0', 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'wifi', 'usuarios', 'apellido', 3, '0', 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'wifi', 'usuarios', 'direccion', 4, '0', 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'wifi', 'usuarios', 'nick', 5, '0', 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'wifi', 'usuarios', 'password', 6, '0', 'NO', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', '');
...
INSERT INTO `GLOBAL_STATUS` (`VARIABLE_NAME`, `VARIABLE_VALUE`) VALUES
	...
	('BYTES_RECEIVED', '17772'),
	('BYTES_SENT', '295166'),
	('COM_ADMIN_COMMANDS', '479'),
	...
	('HANDLER_READ_PREV', '0'),
	('HANDLER_READ_RND', '0'),
	('HANDLER_READ_RND_NEXT', '3255'),
	('HANDLER_ROLLBACK', '11'),
	('HANDLER_SAVEPOINT', '0'),
	('HANDLER_SAVEPOINT_ROLLBACK', '0'),
	('HANDLER_UPDATE', '0'),
	('HANDLER_WRITE', '3089'),
	('INNODB_BUFFER_POOL_PAGES_DATA', '223'),
	('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
	('INNODB_BUFFER_POOL_PAGES_FLUSHED', '288'),
	('INNODB_BUFFER_POOL_PAGES_FREE', '7968'),
	('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
	('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
	('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
	('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
	('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
	('INNODB_BUFFER_POOL_READ_REQUESTS', '2189'),
	('INNODB_BUFFER_POOL_READS', '210'),
	('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
	('INNODB_BUFFER_POOL_WRITE_REQUESTS', '491'),
	('INNODB_DATA_FSYNCS', '94'),
	('INNODB_DATA_PENDING_FSYNCS', '0'),
	('INNODB_DATA_PENDING_READS', '0'),
	('INNODB_DATA_PENDING_WRITES', '0'),
	('INNODB_DATA_READ', '5623808'),
	('INNODB_DATA_READS', '220'),
	('INNODB_DATA_WRITES', '218'),
	('INNODB_DATA_WRITTEN', '4775424'),
	('INNODB_DBLWR_PAGES_WRITTEN', '144'),
	('INNODB_DBLWR_WRITES', '19'),
	('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
	('INNODB_LOG_WAITS', '0'),
	('INNODB_LOG_WRITE_REQUESTS', '67'),
	('INNODB_LOG_WRITES', '35'),
	('INNODB_OS_LOG_FSYNCS', '55'),
	('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
	('INNODB_OS_LOG_PENDING_WRITES', '0'),
	('INNODB_OS_LOG_WRITTEN', '46592'),
	('INNODB_PAGE_SIZE', '16384'),
	('INNODB_PAGES_CREATED', '14'),
	('INNODB_PAGES_READ', '209'),
	('INNODB_PAGES_WRITTEN', '144'),
...
INSERT INTO `GLOBAL_VARIABLES` (`VARIABLE_NAME`, `VARIABLE_VALUE`) VALUES
	...
	('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\2A5PC08.pid'),
	('KEY_CACHE_DIVISION_LIMIT', '100'),
	('COLLATION_SERVER', 'latin1_swedish_ci'),
	('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\2A5PC08.log'),
	('FLUSH_TIME', '1800'),
	...
	('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\2A5PC08-slow.log'),
...
INSERT INTO `KEY_COLUMN_USAGE` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `POSITION_IN_UNIQUE_CONSTRAINT`, `REFERENCED_TABLE_SCHEMA`, `REFERENCED_TABLE_NAME`, `REFERENCED_COLUMN_NAME`) VALUES
	...
	('def', 'tienda', 'PRIMARY', 'def', 'tienda', 'articulos', 'cod', 1, NULL, NULL, NULL, NULL),
	('def', 'tienda', 'PRIMARY', 'def', 'tienda', 'categorias', 'id', 1, NULL, NULL, NULL, NULL),
	('def', 'wifi', 'PRIMARY', 'def', 'wifi', 'admins', 'id', 1, NULL, NULL, NULL, NULL),
	('def', 'wifi', 'PRIMARY', 'def', 'wifi', 'categorias', 'id', 1, NULL, NULL, NULL, NULL),
	('def', 'wifi', 'PRIMARY', 'def', 'wifi', 'productos', 'id', 1, NULL, NULL, NULL, NULL),
	('def', 'wifi', 'FK_productos_categorias', 'def', 'wifi', 'productos', 'idCategoria', 1, 1, 'wifi', 'categorias', 'id'),
	('def', 'wifi', 'PRIMARY', 'def', 'wifi', 'usuarios', 'id', 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `PARTITIONS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `PARTITION_NAME`, `SUBPARTITION_NAME`, `PARTITION_ORDINAL_POSITION`, `SUBPARTITION_ORDINAL_POSITION`, `PARTITION_METHOD`, `SUBPARTITION_METHOD`, `PARTITION_EXPRESSION`, `SUBPARTITION_EXPRESSION`, `PARTITION_DESCRIPTION`, `TABLE_ROWS`, `AVG_ROW_LENGTH`, `DATA_LENGTH`, `MAX_DATA_LENGTH`, `INDEX_LENGTH`, `DATA_FREE`, `CREATE_TIME`, `UPDATE_TIME`, `CHECK_TIME`, `CHECKSUM`, `PARTITION_COMMENT`, `NODEGROUP`, `TABLESPACE_NAME`) VALUES
	('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-01-31 13:47:47', '2014-01-31 13:47:47', NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-01-31 13:47:47', '2014-01-31 13:47:47', NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-01-31 13:47:47', '2014-01-31 13:47:47', NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-01-31 13:47:47', '2014-01-31 13:47:47', NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-01-31 13:47:47', '2014-01-31 13:47:47', NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-01-31 13:47:47', '2014-01-31 13:47:47', NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-01-31 13:47:47', '2014-01-31 13:47:47', NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-01-31 13:47:47', '2014-01-31 13:47:47', NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2014-01-31 13:47:47', '2014-01-31 13:47:47', NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2014-01-31 13:47:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', '2012-04-19 16:02:40', NULL, '', '', NULL),
	('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 16:02:40', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
	('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1029, 9, 9261, 2533274790395903, 19456, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 875, 444876, 281474976710655, 20480, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 16:02:40', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 16:02:40', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2012-04-19 16:02:40', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2012-04-19 16:02:40', '2012-04-19 16:02:40', '2012-04-19 16:02:40', NULL, '', '', NULL),
	('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
	('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2012-04-19 16:02:40', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2012-04-19 16:02:40', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, NULL, '', '', NULL),
	...
	('def', 'tienda', 'articulos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, 1489, 16384, NULL, 0, 9437184, '2014-01-17 11:43:47', NULL, NULL, NULL, '', '', NULL),
	('def', 'tienda', 'categorias', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 9437184, '2014-01-08 11:41:36', NULL, NULL, NULL, '', '', NULL),
	('def', 'wifi', 'admins', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 9437184, '2014-01-31 13:22:18', NULL, NULL, NULL, '', '', NULL),
	('def', 'wifi', 'categorias', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 2048, 16384, NULL, 0, 9437184, '2014-01-31 13:13:44', NULL, NULL, NULL, '', '', NULL),
	('def', 'wifi', 'productos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 16384, 9437184, '2014-01-31 13:23:38', NULL, NULL, NULL, '', '', NULL),
	('def', 'wifi', 'usuarios', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 9437184, '2014-01-31 13:18:25', NULL, NULL, NULL, '', '', NULL);
...
INSERT INTO `PROCESSLIST` (`ID`, `USER`, `HOST`, `DB`, `COMMAND`, `TIME`, `STATE`, `INFO`) VALUES
	(3, 'root', 'localhost:50597', 'wifi', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST` LIMIT 104857600');
...
INSERT INTO `REFERENTIAL_CONSTRAINTS` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `UNIQUE_CONSTRAINT_CATALOG`, `UNIQUE_CONSTRAINT_SCHEMA`, `UNIQUE_CONSTRAINT_NAME`, `MATCH_OPTION`, `UPDATE_RULE`, `DELETE_RULE`, `TABLE_NAME`, `REFERENCED_TABLE_NAME`) VALUES
	('def', 'wifi', 'FK_productos_categorias', 'def', 'wifi', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'productos', 'categorias');
...
INSERT INTO `SCHEMATA` (`CATALOG_NAME`, `SCHEMA_NAME`, `DEFAULT_CHARACTER_SET_NAME`, `DEFAULT_COLLATION_NAME`, `SQL_PATH`) VALUES
	...
	('def', 'tienda', 'latin1', 'latin1_swedish_ci', NULL),
	('def', 'wifi', 'latin1', 'latin1_swedish_ci', NULL);
...
INSERT INTO `SESSION_STATUS` (`VARIABLE_NAME`, `VARIABLE_VALUE`) VALUES
	...
	('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
	('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
	('INNODB_BUFFER_POOL_READ_REQUESTS', '2336'),
	('INNODB_BUFFER_POOL_READS', '210'),
	('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
	('INNODB_BUFFER_POOL_WRITE_REQUESTS', '491'),
	('INNODB_DATA_FSYNCS', '94'),
	...
	('THREADS_RUNNING', '1'),
	('UPTIME', '2739'),
	('UPTIME_SINCE_FLUSH_STATUS', '2739');
...
INSERT INTO `STATISTICS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `NON_UNIQUE`, `INDEX_SCHEMA`, `INDEX_NAME`, `SEQ_IN_INDEX`, `COLUMN_NAME`, `COLLATION`, `CARDINALITY`, `SUB_PART`, `PACKED`, `NULLABLE`, `INDEX_TYPE`, `COMMENT`, `INDEX_COMMENT`) VALUES
	...
	('def', 'tienda', 'articulos', 0, 'tienda', 'PRIMARY', 1, 'cod', 'A', 11, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'tienda', 'categorias', 0, 'tienda', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'wifi', 'admins', 0, 'wifi', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'wifi', 'categorias', 0, 'wifi', 'PRIMARY', 1, 'id', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'wifi', 'productos', 0, 'wifi', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'wifi', 'productos', 1, 'wifi', 'FK_productos_categorias', 1, 'idCategoria', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'wifi', 'usuarios', 0, 'wifi', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', '');
...
INSERT INTO `TABLES` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `TABLE_TYPE`, `ENGINE`, `VERSION`, `ROW_FORMAT`, `TABLE_ROWS`, `AVG_ROW_LENGTH`, `DATA_LENGTH`, `MAX_DATA_LENGTH`, `INDEX_LENGTH`, `DATA_FREE`, `AUTO_INCREMENT`, `CREATE_TIME`, `UPDATE_TIME`, `CHECK_TIME`, `TABLE_COLLATION`, `CHECKSUM`, `CREATE_OPTIONS`, `TABLE_COMMENT`) VALUES
	('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
	('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
	('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
	('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-01-31 13:47:48', '2014-01-31 13:47:48', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
	('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
	('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
	('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-01-31 13:47:48', '2014-01-31 13:47:48', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
	('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
	('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
	('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-01-31 13:47:48', '2014-01-31 13:47:48', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
	('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-01-31 13:47:48', '2014-01-31 13:47:48', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
	('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-01-31 13:47:48', '2014-01-31 13:47:48', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
	('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-01-31 13:47:48', '2014-01-31 13:47:48', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
	('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
	('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
	('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-01-31 13:47:48', '2014-01-31 13:47:48', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
	('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
	('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
	('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
	('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
	('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
	('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
	('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
	('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
	('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-01-31 13:47:48', '2014-01-31 13:47:48', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
	('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
	('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2014-01-31 13:47:48', '2014-01-31 13:47:48', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
	('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
	('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
	('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
	('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
	('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
	('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
	('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2014-01-31 13:47:48', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
	('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
	('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2012-04-19 16:02:39', '2012-04-19 16:02:40', '2012-04-19 16:02:40', 'utf8_bin', NULL, '', 'Database privileges'),
	('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 16:02:40', '2012-04-19 16:02:40', NULL, 'utf8_general_ci', NULL, '', 'Events'),
	('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
	('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
	('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
	('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
	('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1029, 9, 9261, 2533274790395903, 19456, 0, NULL, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
	('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 875, 444876, 281474976710655, 20480, 0, NULL, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
	('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
	('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 16:02:40', '2012-04-19 16:02:40', NULL, 'latin1_swedish_ci', NULL, '', ''),
	('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
	('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 16:02:40', '2012-04-19 16:02:40', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
	('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2012-04-19 16:02:40', '2012-04-19 16:02:40', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
	('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2012-04-19 16:02:40', '2012-04-19 16:02:40', '2012-04-19 16:02:40', 'utf8_bin', NULL, '', 'User proxy privileges'),
	('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
	('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
	('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
	('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
	('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2012-04-19 16:02:40', '2012-04-19 16:02:40', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
	('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
	('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
	('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2012-04-19 16:02:40', '2012-04-19 16:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
	('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2012-04-19 16:02:39', '2012-04-19 16:02:40', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
	...
	('def', 'tienda', 'articulos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 11, 1489, 16384, 0, 0, 9437184, NULL, '2014-01-17 11:43:47', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
	('def', 'tienda', 'categorias', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 9437184, NULL, '2014-01-08 11:41:36', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
	('def', 'wifi', 'admins', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, 1, '2014-01-31 13:22:18', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
	('def', 'wifi', 'categorias', 'BASE TABLE', 'InnoDB', 10, 'Compact', 8, 2048, 16384, 0, 0, 9437184, 9, '2014-01-31 13:13:44', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
	('def', 'wifi', 'productos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 16384, 9437184, 4, '2014-01-31 13:23:38', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
	('def', 'wifi', 'usuarios', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, 1, '2014-01-31 13:18:25', NULL, NULL, 'latin1_swedish_ci', NULL, '', '');
...
INSERT INTO `TABLE_CONSTRAINTS` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `TABLE_SCHEMA`, `TABLE_NAME`, `CONSTRAINT_TYPE`) VALUES
	...
	('def', 'tienda', 'PRIMARY', 'tienda', 'articulos', 'PRIMARY KEY'),
	('def', 'tienda', 'PRIMARY', 'tienda', 'categorias', 'PRIMARY KEY'),
	('def', 'wifi', 'PRIMARY', 'wifi', 'admins', 'PRIMARY KEY'),
	('def', 'wifi', 'PRIMARY', 'wifi', 'categorias', 'PRIMARY KEY'),
	('def', 'wifi', 'PRIMARY', 'wifi', 'productos', 'PRIMARY KEY'),
	('def', 'wifi', 'FK_productos_categorias', 'wifi', 'productos', 'FOREIGN KEY'),
	('def', 'wifi', 'PRIMARY', 'wifi', 'usuarios', 'PRIMARY KEY');
...
-- Volcando datos para la tabla mysql.event: 0 rows
...
-- Volcando datos para la tabla mysql.general_log: 2 rows
...
-- Volcando datos para la tabla mysql.help_category: 38 rows
...
-- Volcando datos para la tabla mysql.help_keyword: 465 rows
...
-- Volcando datos para la tabla mysql.help_relation: 1.029 rows
...
-- Volcando datos para la tabla mysql.help_topic: 508 rows
...
-- Volcando datos para la tabla mysql.ndb_binlog_index: 0 rows
...
-- Volcando datos para la tabla mysql.plugin: 0 rows
...
-- Volcando datos para la tabla mysql.servers: 0 rows
...
-- Volcando datos para la tabla mysql.slow_log: 2 rows
...
-- Volcando datos para la tabla mysql.user: 4 rows
...
INSERT INTO `user` (`Host`, `User`, `Password`, `Select_priv`, `Insert_priv`, `Update_priv`, `Delete_priv`, `Create_priv`, `Drop_priv`, `Reload_priv`, `Shutdown_priv`, `Process_priv`, `File_priv`, `Grant_priv`, `References_priv`, `Index_priv`, `Alter_priv`, `Show_db_priv`, `Super_priv`, `Create_tmp_table_priv`, `Lock_tables_priv`, `Execute_priv`, `Repl_slave_priv`, `Repl_client_priv`, `Create_view_priv`, `Show_view_priv`, `Create_routine_priv`, `Alter_routine_priv`, `Create_user_priv`, `Event_priv`, `Trigger_priv`, `Create_tablespace_priv`, `ssl_type`, `ssl_cipher`, `x509_issuer`, `x509_subject`, `max_questions`, `max_updates`, `max_connections`, `max_user_connections`, `plugin`, `authentication_string`) VALUES
	('localhost', 'root', '', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', _binary '', _binary '', _binary '', 0, 0, 0, 0, '', ''),
	...
	('localhost', '', '', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', _binary '', _binary '', _binary '', 0, 0, 0, 0, '', NULL);
...
-- Volcando datos para la tabla performance_schema.cond_instances: 1.000 rows
...
-- Volcando datos para la tabla performance_schema.events_waits_current: 1.000 rows
...
-- Volcando datos para la tabla performance_schema.events_waits_history: 1.000 rows
...
-- Volcando datos para la tabla performance_schema.events_waits_history_long: 10.000 rows
...
-- Volcando datos para la tabla performance_schema.events_waits_summary_by_instance: 1.000 rows
...
-- Volcando datos para la tabla performance_schema.events_waits_summary_by_thread_by_event_name: 1.000 rows
...
-- Volcando datos para la tabla performance_schema.events_waits_summary_global_by_event_name: 1.000 rows
...
-- Volcando datos para la tabla performance_schema.file_instances: 1.000 rows
...
-- Volcando datos para la tabla performance_schema.file_summary_by_event_name: 1.000 rows
...
-- Volcando datos para la tabla performance_schema.file_summary_by_instance: 1.000 rows
...
-- Volcando datos para la tabla performance_schema.mutex_instances: 1.000 rows
...
-- Volcando datos para la tabla performance_schema.performance_timers: 5 rows
...
-- Volcando datos para la tabla performance_schema.rwlock_instances: 1.000 rows
...
-- Volcando datos para la tabla performance_schema.setup_consumers: 8 rows
...
-- Volcando datos para la tabla performance_schema.setup_instruments: 1.000 rows
...
-- Volcando datos para la tabla performance_schema.setup_timers: 1 rows
...
-- Volcando datos para la tabla performance_schema.threads: 1.000 rows
/*!40000 ALTER TABLE `threads` DISABLE KEYS */;
/*!40000 ALTER TABLE `threads` ENABLE KEYS */;


-- Volcando estructura de base de datos para wifi
CREATE DATABASE IF NOT EXISTS `wifi` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `wifi`;


-- Volcando estructura para tabla wifi.admins
...
-- Volcando datos para la tabla wifi.admins: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `admins` DISABLE KEYS */;
/*!40000 ALTER TABLE `admins` ENABLE KEYS */;


-- Volcando estructura para tabla wifi.categorias
...
-- Volcando datos para la tabla wifi.categorias: ~8 rows (aproximadamente)
...
-- Volcando estructura para tabla wifi.productos
CREATE TABLE IF NOT EXISTS `productos` (
  ...
  CONSTRAINT `FK_productos_categorias` FOREIGN KEY (`idCategoria`) REFERENCES `categorias` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla wifi.productos: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `productos` DISABLE KEYS */;
INSERT INTO `productos` (`id`, `nombre`, `precio`, `descripcion`, `idCategoria`) VALUES
	(1, 'Tube-U (N) Alfa Network Adaptador Wifi Ext. USB Co', 32, 'High Gain USB Antenna', 1),
	(2, 'Tube-U (G) Alfa Network Adaptador Wifi Ext. Conect', 30, 'High Gain USB Antenna', 1),
	(3, 'Ubiquiti WIFISTATION Adaptador Ext. WLAN USB 2.4GH', 28, 'Ubitiqui high gain USB antenna', 1);
/*!40000 ALTER TABLE `productos` ENABLE KEYS */;


-- Volcando estructura para tabla wifi.usuarios
...
-- Volcando datos para la tabla wifi.usuarios: ~0 rows (aproximadamente)
